...
var app = {
    ...
    cacheDOM: function() {
        ...
        // jQuery(".multi-step-form").find("form#universalForm").html();
        this.$formParent = jQuery(".multi-step-form");
        this.$form = this.$formParent.find("form#universalForm");
    ...
    nextButton: function() {
        this.$nextButton.on("click", function(e) {              
            e.preventDefault();
            console.log("validation",app.checkForValidForm());
    ...
    validateForm: function() {
        ...
        this.$form.validate({
            ...
            rules: {
                ...
                microchipNumber:{
                    ...
                    /*"remote":
                    {
                      ...
                      data:
                      {
                         ...
                         {
                             return $('#universalForm :input[name="universal_microchip_id"]').val();
                        }
                      }
                    }*/
                },
                ...
                p_email:{
                    ...
                    remote:{
                        url: ajaxurl,
                        type: "post",
                        data:{'action':'checkEmailExist',"userEmail":$('#universalForm:input[name="p_email"]').val()}
                    }
                },
                    ...
                    remote:{
                        ...
                        data:{
                            ...
                            priary_phone: function(){
                                return $('#universalForm :input[name="p_prm_no"]').val();
                            }
                        }
                    }
                },
            ...
            submitHandler: function(f) {
                ...
                var files_data = $('#universalForm .files-data');
                var data = "";
            ...
            $.each($('#universalForm .user-data'), function() {
                ufd.append($(this).attr('name'), $(this).val());
            });

            $.each($('#universalForm .protectArg'), function() {
                petAramnt.append($(this).attr('name'), $(this).val());
        	}); 

            $.each($('#universalForm .PetInsurance'), function() {
              insfd.append($(this).attr('name'), $(this).val());
            });
    
            $.each($('#universalForm .customdata'), function() {
