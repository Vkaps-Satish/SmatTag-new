<?php 
/*
* Template Name:  SmartTag registry New
*/
get_header();
		...
		<div class="row">
			...
			<div class="woo-content col-sm-9" id="woo-content">
				...
				<section class="multi-step-form">
				  	<form id="profileuser1" method="POST" enctype="multipart/form-data" autocomplete="false">		
						<fieldset aria-label="Step One" tabindex="-1" id="step-1" class="step-form-box">
							<div class="contact-form" id="pro-info">	
						    	<div class="field-wrap two-fields-wrap">
									...
									<div class="field-div">
										<label> </label>
										<input type="text" name="conf_smarttag_id_number" placeholder="Confirm Serial Number" class="sereal-number-2 text-data break_number-4" required="" value="<?= (isset($_GET['id'])) ? $_GET['id'] : "" ?>" />
									</div>							
								</div>
								<div class="field-wrap two-fields-wrap">
						        	<div class="field-div">
									...
									<div class="field-div">
						          	...
						          	<div class="field-div">
										<label>Pet Date of Birth</label>
											<input type="date" name="pet_date_of_birth" id="pet-dob1-1" autocomplete="false" placeholder="mm/dd/yyyy" class="input-10 input text-data">
						         	</div>
						      	</div>	
							        <div class="field-wrap two-fields-wrap">
									...
									<div class="contact-form" id="sec-cont-info">
										...
										<div class="field-wrap two-fields-wrap">
											<div class="field-div phone-div">
												...
												<input type="hidden" name="s_prm_no_code" placeholder="(555) 123-1234" class="user-data" value="<?php echo $secondary_phone_country_code;0 ?>" />
											</div>
											<div class="field-div phone-div">
												<label>Secondary Phone Number</label>
									...
									<table class="pp-table">
										<thead>
										    <tr class="pt-remove">
										      ...
										      <th class="pp-silver">
										       <h2><img src="<?= site_url() ?>/wp-content/uploads/2021/01/Group_1-removebg-preview.png">
										      </th>
										      <th class="pp-gold">
