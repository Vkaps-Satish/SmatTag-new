<?php 
   /*
   * Template Name: Register Univarsal Micochip Id Tag
   */
   global $protectionArrangement,$heth_proid,$petColors;
;
   ...
   ?>
   <section class="multi-step-form gaurav">
      <form id="profileuser1" method="POST" enctype="multipart/form-data">
            ...
            <div class="contact-form" id="pro-info">  
               <div class="field-wrap two-fields-wrap">
                  <div class="field-div">
                     ...
                     <input type="text" placeholder="Microchip Id Number" name="universal_microchip_id" class="text-data dog_universal_microchip_id error" id="sname_input" required=""  />
                  </div>
                  <div class="field-div">
                     <label> </label>
                     <input type="text" name="conf_universal_microchip_id" placeholder="Confirm Microchip Id Number" class="text-data"required="" />
                  </div>                     
               </div>
               <div class="field-wrap two-fields-wrap">
                  <div class="field-div">
                     <label>*Choose Your Microchip Brand12:</label>
                     <select name="microchip_company" class="text-data" id="brand" required="" >
       ...
       <div class="field-wrap two-fields-wrap">
         <div class="field-div">
          ...
          <input type="file" name="files" class="files-data" multiple id="imgInp" />
       </div>
       <div class="field-div">
         <label></label>
   ...
   <?php  if(is_user_logged_in()) { ?>
     ...
     <!--  <div class="field-wrap two-fields-wrap">
         <div class="field-div">
            ...
            <input type="number" name="p_prm_no" placeholder="1(555) 123-1234" class="user-data" id="p-phone"  required="" value="<?php echo $primary_home_number;?>" readonly />
         </div>
         <div class="field-div">
...
<?php }else{ ?>
   <div class="contact-form" id="cus-info">
      ...
      <!-- <div class="field-wrap two-fields-wrap">
         <div class="field-div">
            <label>*Primary Phone Number </label>
            <input type="number" name="p_prm_no" placeholder="1(555) 123-1234" class="user-data" id="p-phone"  required="" value="" />
         </div>
         <div class="field-div">
            <label>Secondary Phone Number </label>
            <input type="number" name="p_sec_no" placeholder="1(555) 123-1234" class="user-data" id="ps-phone" value="" />
         </div>
      </div> -->
   </div>
   <div class="step-accordion">
               ...
               <tr>
                  ...
                  <th class="pp-silver">
                     ...
                     <div class="pp-membership-plan">
                        ...
                        <div class="pp-adc-btn">
                           <a id="Stsil1" filed="productid" proid="6909" class="site-btn subPlans" price="6.95" PlanNm="Id Tag 1 Year Plan">Add to Cart <i class="fa fa-shopping-cart"></i></a>
                        </div>
                     </div>
                     <div class="pp-membership-plan">
                        ...
                        <div class="pp-adc-btn">
                           <a id="Stsil2" filed="productid" proid="6910" class="site-btn subPlans" price="14.95" PlanNm="Id Tag Lifetime Plan">Add to Cart <i class="fa fa-shopping-cart"></i></a>
                        </div>
                     </div>
                  </th>
                  <th class="pp-gold">
                     ...
                     <div class="pp-membership-plan">
                        ...
                        <div class="pp-adc-btn">
                           <a id="Sgol1" filed="productid" proid="6911" class="site-btn subPlans" price="9.95" PlanNm="Id Tag 1 Year Plan">Add to Cart <i class="fa fa-shopping-cart"></i></a>
                        </div>
                     </div>
                     <div class="pp-membership-plan">
                        <div class="pp-plan-name">Id Tag Lifetime Plan</div>
                        ...
                        <div class="pp-adc-btn">
                           <a id="Sgol2" filed="productid" proid="6912" class="site-btn subPlans" price="29.95" PlanNm="Id Tag Lifetime Plan">Add to Cart <i class="fa fa-shopping-cart"></i></a>
                        </div>
                     </div>
                  </th>
                  <th class="pp-platinum">
                     ...
                     <div class="pp-membership-plan">
                        ...
                        <div class="pp-adc-btn">
                           <a id="sple1" filed="productid" proid="6913" class="site-btn subPlans" price="19.95" PlanNm="Id Tag 1 Year Plan">Add to Cart <i class="fa fa-shopping-cart"></i></a>
                        </div>
                     </div>
                     <div class="pp-membership-plan">
                        <div class="pp-plan-name">Id Tag Lifetime Plan</div>
                        ...
                        <div class="pp-adc-btn">
                           <a id="sple2" filed="productid" proid="6914" class="site-btn subPlans" price="49.95" PlanNm="Id Tag 5 Year Plan" >Add to Cart <i class="fa fa-shopping-cart"></i></a>
                        </div>
                     </div>
                  </th>
               </tr>
                           ...
                           <div class="acc-blue-content">
                              <div class="row">
                                 ...
                                 <div class="col-sm-6 mar-bot">
                                    ...
                                    <strong>Primary Phone Number:</strong> <span id="vaterinarian_primary_phone_number_code"></span><span id="vprim"></span><br>
                                    <strong>Secondary Phone Number:</strong> <span id="vaterinarian_secondary_phone_number_code"></span><span id="vsec"></span>
                                 </div>
                              </div>
                           </div>
                        </div>
