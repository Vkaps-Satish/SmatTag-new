...
$handle=new WC_Product_Variable(6137);
                                            ...
                                            <tr>
                                                ...
                                                <th class="pp-silver">
                                                    ...
                                                    <div class="pp-membership-plan">
                                                        ...
                                                        <div class="pp-adc-btn">
                                                            <a href="javascript:void(0)" id="Stsil1" filed="productid" productid="<?php echo $SubPlan[0];?>" class="site-btn SubPln" protection="silver" plan="1-year">Add to Cart <i class="fa fa-shopping-cart"></i></a>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="pp-membership-plan">
                                                        ...
                                                        <div class="pp-adc-btn">
                                                            <a href="javascript:void(0)" id="Stsil2" filed="productid" productid="<?php echo $SubPlan[1];?>" class="site-btn SubPln" protection="silver" plan="5-year">Add to Cart <i class="fa fa-shopping-cart"></i></a>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="pp-membership-plan">
                                                        ...
                                                        <div class="pp-adc-btn">
                                                            <a href="javascript:void(0)" id="Stsil3" filed="productid" productid="<?php echo $SubPlan[2];?>" class="site-btn SubPln" protection="silver" plan="lifetime">Add to Cart <i class="fa fa-shopping-cart"></i></a>
                                                        </div>
                                                    </div>
                                                    <?php }} ?>
                                                </th>
                                                <th class="pp-gold">
                                                    ...
                                                    <div class="pp-membership-plan">
                                                        ...
                                                        <div class="pp-adc-btn">
                                                            <a href="javascript:void(0)" id="Stgol1" filed="productid" productid="<?php echo $SubPlan[3];?>" class="site-btn SubPln" protection="gold" plan="1-year">Add to Cart <i class="fa fa-shopping-cart"></i></a>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="pp-membership-plan">
                                                        ...
                                                        <div class="pp-adc-btn">
                                                            <a href="javascript:void(0)" id="Stgol2" filed="productid" productid="<?php echo $SubPlan[4];?>" class="site-btn SubPln" protection="gold" plan="5-year">Add to Cart <i class="fa fa-shopping-cart"></i></a>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="pp-membership-plan">
                                                        ...
                                                        <div class="pp-adc-btn">
                                                            <a href="javascript:void(0)" id="Stgol3" filed="productid" productid="<?php echo $SubPlan[5];?>" class="site-btn SubPln" protection="gold" plan="lifetime">Add to Cart <i class="fa fa-shopping-cart"></i></a>
                                                        </div>
                                                    </div>
                                                    <?php }} ?>
                                                </th>
                                                <th class="pp-platinum">
                                                    ...
                                                    <div class="pp-membership-plan">
                                                        ...
                                                        <div class="pp-adc-btn">
                                                            <a href="javascript:void(0)" id="stple1" filed="productid" productid="<?php echo $SubPlan[6];?>" class="site-btn SubPln" protection="platinum" plan="1-year">Add to Cart <i class="fa fa-shopping-cart"></i></a>
                                                        </div>
                                                    </div>
                                                    <?PHP }}if(!empty($SubPlan[7])){
                                                    ...
                                                    <div class="pp-membership-plan">
                                                        ...
                                                        <div class="pp-adc-btn">
                                                            <a href="javascript:void(0)" id="stple2" filed="productid" productid="<?php echo $SubPlan[7];?>" class="site-btn SubPln" protection="platinum" plan="5-year">Add to Cart <i class="fa fa-shopping-cart"></i></a>
                                                        </div>
                                                    </div>
                                                    <?PHP }}if(!empty($SubPlan[8])){
                                                    ...
                                                    <div class="pp-membership-plan">
                                                        ...
                                                        <div class="pp-adc-btn">
                                                            <a href="javascript:void(0)" id="stple3" filed="productid" productid="<?php echo $SubPlan[8];?>" class="site-btn SubPln" protection="platinum" plan="lifetime">Add to Cart <i class="fa fa-shopping-cart"></i></a>
                                                        </div>
                                                    </div>
                                                    <?PHP }}?>
                                                </th>
