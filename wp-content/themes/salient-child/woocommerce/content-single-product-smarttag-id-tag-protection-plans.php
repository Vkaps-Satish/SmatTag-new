...
if(isset($_GET['switch-subscription'])){
  ...
  foreach( $subscription->get_items() as $item_id => $product_subscription ){
    ...
    //SmartTag Pet Protection Plan Parent Id 6137
  $handle = new WC_Product_Variable($SmtProPlan);
  ...
  //SmartTag Pet Protection Plan Parent Id 6137
      ...
      <?php  //custom comment for error handeling Warning: Undefined variable $petdata added by developer
      if(isset($petdata)) { foreach ($petdata as $post) { ?>
        <style type="text/css">
    ...
    <style type="text/css">
      .postid-<?= $SmtProPlan;?> .page-heading, #product-<?= $SmtProPlan;?> {
        display: none;
      }
    </style>
      ...
      <?php
          ...
          <?php if($tabs){ ?>
            <div class="pp-tabs-nav">
              <div class="pp-tabs-nav-inner pp-tab-option-1  ">
                <a href="<?= get_permalink($micoPrntId); ?>">
                  SmartTag Microchip Protection Plans
                </a>
              </div>
              <div class="pp-tabs-nav-inner pp-tab-option-2 active ">
          ...
          <div class="pp-tabs-content">
            ...
            <div class="pp-tabs-content steps-pp-tabs-content">
          ...
          <i class="fa fa-check"></i>
                  ...
                  <tfoot>
                    <tr>
                          ...
                          <?php }else{ ?>
                            <div class="pp-membership-plan">
                              ...
                              <div class="pp-plan-price">
                                <h3><?= "$".get_post_meta($SubPlan[0], '_price', true). "<p>per year</p>"; ?></h3>

                              </div>
                              <div class="pp-adc-btn">
                                <a href="javascript:void(0)" id="Stsil1" filed="productid" productid="<?php echo $SubPlan[0];?>" variation_id = 
                                '6850' class="site-btn SubPln" protection="silver" plan="1-year">Add to Cart <i class="fa fa-shopping-cart"></i></a>
                              </div>
                            </div>
                          <?php }
                        }
                        if(!empty($SubPlan[1])){
                          ...
                          <?php  }else{ ?>
                            <div class="pp-membership-plan">
                              <div class="pp-plan-name">Id Tag 5 Year Plan</div>
                              <div class="pp-plan-price">
                                <h3><?= "$".get_post_meta($SubPlan[1], '_price', true); ?></h3>

                              </div>
                              <div class="pp-adc-btn">
                                <a href="javascript:void(0)" id="Stsil2" filed="productid" productid="<?php echo $SubPlan[1];?>"  variation_id = 
                                '6851'class="site-btn SubPln" protection="silver" plan="5-year">Add to Cart <i class="fa fa-shopping-cart"></i></a>
                              </div>
                            </div>
                          <?php }
                        }if(!empty($SubPlan[2])){
                          ...
                          <?php }else{ ?>
                            <div class="pp-membership-plan">
                              ...
                              <div class="pp-adc-btn">
                                <a href="javascript:void(0)" id="Stsil3" filed="productid" productid="<?php echo $SubPlan[2];?>" variation_id = 
                                '6852' class="site-btn SubPln" protection="silver" plan="lifetime">Add to Cart <i class="fa fa-shopping-cart"></i></a>
                              </div>
                            </div>
                          <?php }
                        } ?>
                        ...
                        <?php if(!empty($SubPlan[3])){
                          ...
                          <?php }else{?>
                            <div class="pp-membership-plan">
                              ...
                              <div class="pp-adc-btn">
                                <a href="javascript:void(0)" id="Stgol1" filed="productid" productid="<?php echo $SubPlan[3];?>" variation_id = 
                                '6853' class="site-btn SubPln" protection="gold" plan="1-year">Add to Cart <i class="fa fa-shopping-cart"></i></a>
                              </div>
                            </div>
                          <?php }
                        }if(!empty($SubPlan[4])){
                          ...
                          <?php }else{?>
                            <div class="pp-membership-plan">
                              ...
                              <div class="pp-adc-btn">
                                <a href="javascript:void(0)" id="Stgol2" filed="productid" productid="<?php echo $SubPlan[4];?>"  variation_id = 
                                '6854' class="site-btn SubPln" protection="gold" plan="5-year">Add to Cart <i class="fa fa-shopping-cart"></i></a>
                              </div>
                            </div>
                          <?php }
                        }if(!empty($SubPlan[5])){
                          ...
                          <?php }else{?>
                            <div class="pp-membership-plan">
                              <div class="pp-plan-name">Id Tag Lifetime Plan</div>
                              <div class="pp-plan-price">
                                <h3><?= "$".get_post_meta($SubPlan[5], '_price', true); ?></h3>
                              </div>
                              <div class="pp-adc-btn">
                                <a href="javascript:void(0)" id="Stgol3" filed="productid" productid="<?php echo $SubPlan[5];?>" variation_id = 
                                '6855'  class="site-btn SubPln" protection="gold" plan="lifetime">Add to Cart <i class="fa fa-shopping-cart"></i></a>
                              </div>
                            </div>
                          <?php }
                        } ?>
                      ...
                      <th class="pp-platinum">
                        <h2>PLATINUM</h2>
                        <?PHP if(!empty($SubPlan[6])){
                          if($SubPlan[6] == $currentPlan){ ?>
                            <div class="pp-membership-plan">
                              <div class="pp-plan-name"><h3>Current Protection Plan</h3></div>
                              <div class="pp-plan-name">Id Tag 1 Year Plan</div>
                              <div class="pp-adc-btn">&nbsp;</div>
                          ...
                          <?php }else{?>
                            <div class="pp-membership-plan">
                              <div class="pp-plan-name">Id Tag 1 Year Plan</div>
                              <div class="pp-plan-price">
                                <h3><?= "$".get_post_meta($SubPlan[6], '_price', true). "<p>per year</p>"; ?></h3>
                              </div>
                              <div class="pp-adc-btn">
                                <a href="javascript:void(0)" id="stple1" filed="productid" productid="<?php echo $SubPlan[6];?>" variation_id = 
                                '6856' class="site-btn SubPln" protection="platinum" plan="1-year">Add to Cart <i class="fa fa-shopping-cart"></i></a>
                              </div>
                            </div>
                          <?php }
                        }
                        if(!empty($SubPlan[7])){
                          if($SubPlan[7] == $currentPlan){ ?>
                            <div class="pp-membership-plan">
                              <div class="pp-plan-name"><h3>Current Protection Plan</h3></div>
                              <div class="pp-plan-name">Id Tag 5 Year Plan</div>
                              <div class="pp-adc-btn">&nbsp;</div>
                          ...
                          <?php }else{?>
                            <div class="pp-membership-plan">
                              <div class="pp-plan-name">Id Tag 5 Year Plan</div>
                              <div class="pp-plan-price">
                                <h3><?= "$".get_post_meta($SubPlan[7], '_price', true); ?></h3>
                              </div>
                              <div class="pp-adc-btn">
                                <a href="javascript:void(0)" id="stple2" filed="productid" productid="<?php echo $SubPlan[7];?>"  variation_id = 
                                '6857' class="site-btn SubPln" protection="platinum" plan="5-year">Add to Cart <i class="fa fa-shopping-cart"></i></a>
                              </div>
                            </div>
                          <?php }
                        }
                        if(!empty($SubPlan[8])){
                          if($SubPlan[8] == $currentPlan){ ?>
                            <div class="pp-membership-plan">
                              <div class="pp-plan-name"><h3>Current Protection Plan</h3></div>
                              <div class="pp-plan-name">Id Tag Lifetime Plan</div>
                              <div class="pp-adc-btn">&nbsp;</div>
                          ...
                          <?php }else{?>
                            <div class="pp-membership-plan">
                              <div class="pp-plan-name">Id Tag Lifetime Plan</div>
                              <div class="pp-plan-price">
                                <h3><?= "$".get_post_meta($SubPlan[8], '_price', true); ?></h3>
                              </div>
                              <div class="pp-adc-btn">
                                <a href="javascript:void(0)" id="stple3" filed="productid" productid="<?php echo $SubPlan[8];?>" class="site-btn SubPln" variation_id = '6858' protection="platinum" plan="lifetime">Add to Cart <i class="fa fa-shopping-cart"></i></a>
                              </div>
                            </div>
                          <?php }
                        }?>
              ...
              <a href="/webhook-pet-profile/" class="btn btn-default btn-next skip1 site-btn" id="skip-plan">Skip Protection Plan <i class="fa fa-caret-right"></i></a>
 ...
 <span class="short-regular" style="position: relative; top: -12px;"><small><em>*must activate with our partner PAWP, see email for directions</em></small></span>
      ...
      <?php do_action( 'woocommerce_after_single_product' ); ?>
       ...
       // $('a.SubPln').click(function(e) {
          // alert()
         $("body").on('click','a.SubPln',function(e){
          e.preventDefault();
        $('.loader-wrap').fadeIn();
   ...
   // $("#AutoCart").click();
                      ...
                      success: function(response) {
                        ...
                        if(response.status == '200'){
                             ...
                             if(referrer.includes('product')){
                                   $('#closed').attr('href','/webhook-pet-profile');
                                   $('.popup-wrap').fadeIn(function(){
                                        $('.popup-content').append('<div class=\"alert alert-success alert-dismissible\" style=\"margin-top:18px;\"><strong>Success! <\/strong>'+response.message+'<\/div>');
                                    });
                              }else{
                                    window.location.href= window.location.hostname+'/cart'; 
                              }
         ...
         // if($('#pa_protection').val() !="" && $('#pa_plan').val() !="" ){
