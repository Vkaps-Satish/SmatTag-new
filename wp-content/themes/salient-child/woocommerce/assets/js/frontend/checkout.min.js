jQuery(function(g) {
    //custom validate for checkout page
// var error = $(document).find("#shipping_state").parent().parent().find('#shipping_state-error');
					// $("#shipping_state").parent().parent().find('.woocommerce-input-wrapper').after(error);
	var validator = $('form[name="checkout"]').validate({
		errorPlacement: function(error, element) {
			  	if(element.attr("name") == "shipping_state"){
			  		if ($("#shipping_state").next("lable#shipping_state-error")) {
						$tt = $("#shipping_state").next("lable#shipping_state-error").clone();
						console.log($tt.html());
						$("#shipping_state").next("lable#shipping_state-error").remove();
						$("#shipping_state").parent().parent().find('.woocommerce-input-wrapper').after('<label id="shipping_state-error" class="error" for="shipping_state">This field is required.</label>');
					}
			  		// $("#shipping_state").parent().parent().find('.woocommerce-input-wrapper').after('<label id="shipping_state-error" class="error" for="shipping_state">This field is required.</label>');
	          	  return true;
                }
                if(element.attr("name") == "billing_state"){
			  		if ($("#billing_state").next("lable#billing_state-error")) {
						$tt = $("#billing_state").next("lable#billing_state-error").clone();
						console.log($tt.html());
						$("#billing_state").next("lable#billing_state-error").remove();
						$("#billing_state").parent().parent().find('.woocommerce-input-wrapper').after('<label id="billing_state-error" class="error" for="billing_state">This field is required.</label>');
					}
			  		// $("#shipping_state").parent().parent().find('.woocommerce-input-wrapper').after('<label id="shipping_state-error" class="error" for="shipping_state">This field is required.</label>');
	          	  return true;
                } 
	    		...
	    		billing_phone: {
                    ...
                    "remote":
                    {
                      ...
                      data:
                      {
                         ...
                         {
                          return $('form.woocommerce-checkout input[name="billing_phone"]').val();
                         }
                      }
                    }
                },
	    		billing_email:{
                    ...
                    "remote":
                    {
                      ...
                      data:
                      {
                         ...
                         userEmail: function()
                         {
                          return $('form.woocommerce-checkout input[name="billing_email"]').val();
                         }
                      }
                    }
                },
            ...
            messages: {
                billing_phone:{
                    remote: "This phone number already exist",
    ...
    var v = {
        updateTimer: !(g.blockUI && g.blockUI.defaults.overlayCSS.cursor == "default"),
            ...
            submit: function() {
                ...
                if($("form.woocommerce-checkout").valid()){
	                ...
	                !1 !== e.triggerHandler("checkout_place_order") && !1 !== e.triggerHandler("checkout_place_order_" + v.get_payment_method()) && (e.addClass("processing"), 1 !== e.data()["blockUI.isBlocked"] && e.block({
	                    message: null,
	                    overlayCSS: {
	                        background: "#fff",
	                        opacity: .6
            ...
            submit: function() {
              //  $(".loader-wrap").fadeIn();
                ...
                return g.ajax({
                    ...
                    data: e,
                    success: function(e) {
                        g(".woocommerce-error, .woocommerce-message").remove(), t.removeClass("processing").unblock(), e && (t.before(e), t.slideUp(), g(document.body).trigger("update_checkout", {
