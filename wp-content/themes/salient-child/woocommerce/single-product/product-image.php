...
<?php
	...
	if (isset($meta['product_extra_image'][0]) && !empty($meta['product_extra_image'][0])) {
		$imageId = $meta['product_extra_image'][0];
		$image = wp_get_attachment_image_src($imageId,"full");
		echo "<div class='prod-second-img mb-30'><img src='".$image[0]."' alt='product second image' /></div>";
	}	
?>
