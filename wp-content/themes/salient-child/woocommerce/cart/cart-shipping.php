...
?>
<div class="shipping-wrap-inner">
	<div class="row">
		<div class="col-sm-7 rmb-30">
			<!-- <div class="shipping-detail">
				<p><strong>When should my order arrive?</strong></p>
				<span>Standard: 7 to 10 business days from date shipping</span></br>
				<span>Priority: 3 to 5 business days from date shipping</span></br>
				<span>Express: 1 to 2 business days from date shipping</span>
			</div> -->
		</div>
	...
	<!-- <p>
		<strong><?php
			if ( $show_package_details ) {
				...
				_e( 'Select Shipping Method:', 'woocommerce' );
			}
		?></strong>
	</p> -->
</div>
