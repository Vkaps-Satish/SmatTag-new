...
<div class="cart_totals <?php if ( WC()->customer->has_calculated_shipping() ) echo 'calculated_shipping'; ?>">
	...
	<table cellspacing="0">
		...
		<?php foreach ( WC()->cart->get_coupons() as $code => $coupon ) : ?>
			<tr class="cart-discount coupon-<?php echo esc_attr( $code ); ?>">
				<?php if($code == 'freeweek'){ ?>
					<th style="display: none;"><?php wc_cart_totals_coupon_label( $coupon ); ?></th>
				<td style="display: none;"><?php wc_cart_totals_coupon_html( $coupon ); ?></td>
		...
		<?php  
		//WC()->cart->tax_display_cart // function deprecated _developer
