<?php 
/*
   * Template Name: Universal Microchips Benefits
   */
?>
...
<div class="pp-table-wrap">
  <table class="pp-table universal-microchips-wrapper">
    <thead>
      <tr>
        <th class="pp-upgrade">
          <span>You will be able to choose your plan for purchase after entering your registration information.</span>
          <p>Hover " <i class="fa fa-plus"></i> " to show more information about each benefit.</p>
        </th>
        <th><img src="<?= site_url() ?>/wp-content/uploads/2021/01/Group_1-removebg-preview.png"></th>
       <th class=""><img src="<?= site_url() ?>/wp-content/uploads/2021/01/smart-tag_protection_plan_buttonsfinal2022_2-removebg-preview.png"></th>
       
        <th><img src="<?= site_url() ?>/wp-content/uploads/2021/01/Group_2-removebg-preview.png"></th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td class="pp-benefits pp-benefits1">
          ...
          Instant Pet "Amber Alert" with a full pet profile, to all shelter and rescue groups in a 50-mile radius of the pet last known location.
        </td>
        <td class="">
      ...
      <tr>
        <td class="pp-benefits pp-benefits2">
          ...
          24/7 Live lost pet call center to field and directly connect to all calls to reunite pet with their owners.
        </td>
        <td class="">
          <i class="fa fa-check"></i>
        </td>
      ...
      <tr>
        <td class="pp-benefits pp-benefits4">
          ...
          All Microchip can be looked up in a Google search.
        </td>
        <td class="">
          <i class="fa fa-check"></i>
        </td>
     ...
     <tr>
      ...
      <!-- <tr>
        <td class="pp-benefits pp-benefits8">
          ...
          Registration with AAHA National Database
        </td>
        <td class="hidden-sliverP">
          <i class="fa fa-check"></i>
        </td>
        <td>
          <i class="fa fa-check"></i>
      ...
      <tr>
        <td class="pp-benefits pp-benefits9">
          ...
          Live Emergency Response Team calling shelters.
        </td>
        <td class=""></td>
        <td>
          <i class="fa fa-check"></i>
      ...
      <tr>
        <td class="pp-benefits pp-benefits11">
          ...
          Engraved Id tag with Microchip number and get pet name.
        </td>
        <td class=""></td>
        <td></td>
        <td>
